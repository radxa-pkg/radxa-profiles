...
.PHONY: debuild
debuild:
	$(CUSTOM_DEBUILD_ENV) debuild \
		--no-lintian --lintian-hook "lintian --fail-on error,warning --suppress-tags-from-file ${CURDIR}/debian/common-lintian-overrides -- %p_%s_*.changes" \
		--no-sign -b $(CUSTOM_DEBUILD_ARG)
